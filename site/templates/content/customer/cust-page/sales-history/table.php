		...
		<?php if ($orderpanel->count == 0 && $input->get->text('ordn') == '') : ?>
			<tr>
				<td colspan="12" class="text-center">
					No Orders found! Try using a date range to find the order(s) you are looking for.
				</td>
			</tr>
		<?php endif; ?>
				...
				<td colspan="3">
					...
					<span class="col-xs-3">
			            <?php if ($order->has_documents()) : ?>
							<a href="<?= $orderpanel->generate_request_documentsURL($order); ?>" class="h3 generate-load-link" title="View Documents" data-loadinto="#cust-sales-history-panel" data-focus="#cust-sales-history-panel">
					...
					<span class="col-xs-3">
						<?php if ($order->has_tracking()) : ?>
							<a href="<?= $orderpanel->generate_request_trackingURL($order); ?>" class="h3 generate-load-link" title="View Tracking" data-loadinto="#cust-sales-history-panel" data-focus="#cust-sales-history-panel">
